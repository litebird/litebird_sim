...
class Mbs:
    def __init__(
        ...
        if parameters is MbsParameters:
            self.params = parameters
        elif parameters is str:
    ...
    def generate_noise(self):
        ...
        root_dir = Path(self.params.output_directory)
                ...
                if n_split:
                    ...
                    for hm in range(n_split):
                        ...
                        lbs.write_healpix_map_to_file(
                            nmc_output_directory / file_name,
                            noise_map_split,
    ...
    def generate_cmb(self):
        ...
        os.environ["PYSM_LOCAL_DATA"] = f"{output_directory}"
        ...
        for nmc in range(rank * perrank, (rank + 1) * perrank):
            ...
            lbs.write_healpix_map_to_file(
                nmc_output_directory / file_name, cmb_temp, column_units=col_units
            )
            sky = pysm3.Sky(
                nside=nside,
                component_objects=[
        ...
        for cmp in components:
            ...
            for Nchnl, chnl in enumerate(channels):
                ...
                if self.params.save:
                    ...
                    file_tot_path = cmp_dir / file_name
                    lbs.write_healpix_map_to_file(
    ...
    def write_coadded_maps(self):
        ...
        for chnl in channels:
            ...
            if cmb_dir.exists():
                ...
                lbs.write_healpix_map_to_file(
                    coadd_dir / tot_file_name, map_tot, column_units=col_units
                )
    ...
    def run_all(self):
        ...
        if rank == 0:
            if self.params.save and self.coadd:
