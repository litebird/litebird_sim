    ...
    def set_parameters(
        ...
        if (self.sim.parameters is not None) and (
            ...
            if mueller_or_jones == "jones":
                self.h1 = float(paramdict.get("h1", False))
                self.h2 = float(paramdict.get("h2", False))
                self.beta = float(paramdict.get("beta", False))
                self.z1 = complex(paramdict.get("z1", False))
                self.z2 = complex(paramdict.get("z2", False))

                self.h1s = float(paramdict.get("h1s", False))
                self.h2s = float(paramdict.get("h2s", False))
                self.betas = float(paramdict.get("betas", False))
                self.z1s = complex(paramdict.get("z1s", False))
                self.z2s = complex(paramdict.get("z2s", False))

            elif mueller_or_jones == "mueller":
                self.mII = float(paramdict.get("mII", False))
                self.mQI = float(paramdict.get("mQI", False))
                self.mUI = float(paramdict.get("mUI", False))
                self.mIQ = float(paramdict.get("mIQ", False))
                self.mIU = float(paramdict.get("mIU", False))
                self.mQQ = float(paramdict.get("mQQ", False))
                self.mUU = float(paramdict.get("mUU", False))
                self.mUQ = float(paramdict.get("mUQ", False))
                self.mQU = float(paramdict.get("mQU", False))

                self.mIIs = float(paramdict.get("mIIs", False))
                self.mQIs = float(paramdict.get("mQIs", False))
                self.mUIs = float(paramdict.get("mUIs", False))
                self.mIQs = float(paramdict.get("mIQs", False))
                self.mIUs = float(paramdict.get("mIUs", False))
                self.mQQs = float(paramdict.get("mQQs", False))
                self.mUUs = float(paramdict.get("mUUs", False))
                self.mUQs = float(paramdict.get("mUQs", False))
                self.mQUs = float(paramdict.get("mQUs", False))
