...
def gen_simulation_and_dets(telescope):
    sim = lbs.Simulation(start_time=start_time, duration_s=time_span_s, random_seed=None)
...
def test_get_detector_orientation(telescope):
    if telescope == "LFT":
        ...
        orient_reference = [0.0,90.0,15.0,105.0,-30.0,-120.0,-45.0,-135.0,60.0,150.0,-75.0,-165.0,90.0,180.0]
    elif telescope == "HFT":
...
@pytest.mark.parametrize("telescope", telescopes)
def test_PointingSys_add_single_offset_to_FP(telescope, make_reference_file=make_reference_file):
...
@pytest.mark.parametrize("telescope", telescopes)
def test_PointingSys_add_multiple_offsets_to_FP(telescope, make_reference_file=make_reference_file):
...
@pytest.mark.parametrize("telescope", telescopes)
def test_PointingSys_add_uncommon_disturb_to_FP(telescope, make_reference_file=make_reference_file):
...
@pytest.mark.parametrize("telescope", telescopes)
def test_PointingSys_add_common_disturb_to_FP(telescope, make_reference_file=make_reference_file):
...
@pytest.mark.parametrize("telescope", telescopes)
def test_PointingSys_add_single_offset_to_spacecraft(telescope, make_reference_file=make_reference_file):
...
@pytest.mark.parametrize("telescope", telescopes)
def test_PointingSys_add_common_disturb_to_spacecraft(telescope, make_reference_file=make_reference_file):
...
if make_reference_file == True:
    ...
    for telescope in telescopes:
        ...
        test_PointingSys_add_common_disturb_to_spacecraft(telescope, make_reference_file)
