...
def test_gaussbeam_circular():
    ...
    expected_alm[1, hp.Alm.getidx(lmax, 2, 2)] = -0.2273741959610235 + 0.15555505672403316j
    expected_alm[1, hp.Alm.getidx(lmax, 3, 2)] = -0.23499883551559272 + 0.16077135329365197j
    expected_alm[1, hp.Alm.getidx(lmax, 4, 2)] = -0.22249416864113872 + 0.1522164504087869j
    expected_alm[1, hp.Alm.getidx(lmax, 5, 2)] = -0.1963335778700126 + 0.13431902733429554j
    expected_alm[2, hp.Alm.getidx(lmax, 2, 2)] = -0.15555505672403316 - 0.2273741959610235j
    expected_alm[2, hp.Alm.getidx(lmax, 3, 2)] = -0.16077135329365197 - 0.23499883551559272j
    expected_alm[2, hp.Alm.getidx(lmax, 4, 2)] = -0.1522164504087869 - 0.22249416864113872j
    expected_alm[2, hp.Alm.getidx(lmax, 5, 2)] = -0.13431902733429554 - 0.1963335778700126j
...
def test_gaussbeam_elliptical():
    ...
    expected_alm[0, hp.Alm.getidx(lmax, 2, 2)] = 0.0256681071151606 - 0.005203182904754614j
    expected_alm[0, hp.Alm.getidx(lmax, 3, 0)] = 0.4662852536091051
    expected_alm[0, hp.Alm.getidx(lmax, 3, 2)] = 0.04794485997107865 - 0.009718904267195683j
    expected_alm[0, hp.Alm.getidx(lmax, 4, 0)] = 0.39112854390813984
    expected_alm[0, hp.Alm.getidx(lmax, 4, 2)] = 0.06637983560826029 - 0.013455858833210285j
    ...
    expected_alm[0, hp.Alm.getidx(lmax, 5, 2)] = 0.07512150149738082 - 0.015227882235998861j
    ...
    expected_alm[1, hp.Alm.getidx(lmax, 2, 2)] = -0.205516866581687 + 0.14030160457109472j
    expected_alm[1, hp.Alm.getidx(lmax, 3, 0)] = -0.045058306539990926
    expected_alm[1, hp.Alm.getidx(lmax, 3, 2)] = -0.19368308440573004 + 0.13138637435273962j
    expected_alm[1, hp.Alm.getidx(lmax, 4, 0)] = -0.06238339172781836
    expected_alm[1, hp.Alm.getidx(lmax, 4, 2)] = -0.16430910498705525 + 0.10983543758200465j
    ...
    expected_alm[1, hp.Alm.getidx(lmax, 5, 2)] = -0.1289506767929808 + 0.08387724340550018j
    ...
    expected_alm[2, hp.Alm.getidx(lmax, 2, 2)] = -0.14043877112078462 - 0.20484020274831682j
    expected_alm[2, hp.Alm.getidx(lmax, 3, 0)] = -0.019050346452933527
    expected_alm[2, hp.Alm.getidx(lmax, 3, 2)] = -0.1318980840261679 - 0.19115874133537236j
    expected_alm[2, hp.Alm.getidx(lmax, 4, 0)] = -0.026375274984407938
    expected_alm[2, hp.Alm.getidx(lmax, 4, 2)] = -0.11101235042399053 - 0.1585032116624718j
    expected_alm[2, hp.Alm.getidx(lmax, 4, 4)] = -0.02429323699423821 - 0.02342079121136466j
    expected_alm[2, hp.Alm.getidx(lmax, 5, 0)] = -0.029848676801912326
    expected_alm[2, hp.Alm.getidx(lmax, 5, 2)] = -0.0858624812886358 - 0.11915719085059061j
