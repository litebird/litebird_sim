...
def test_smart_pointings_angles(tmp_path):
    ...
    np.testing.assert_allclose(
        ...
        desired=np.array(
            [
                [1.6580628157, 0.0000000000, -1.5707963705],
                [1.6580530405, 0.0040741358, -1.5665333271],
                [1.6580240726, 0.0081481803, -1.5622704029],
                [1.6579757929, 0.0122220432, -1.5580075979],
                [1.6579082012, 0.0162956323, -1.5537451506],
                [1.6578212976, 0.0203688517, -1.5494830608],
                [1.6577150822, 0.0244416166, -1.5452214479],
                [1.6575895548, 0.0285138357, -1.5409603119],
                [1.6574447155, 0.0325854160, -1.5367000103],
                [1.6572806835, 0.0366562679, -1.5324403048],
            ]
        ),
        rtol=1e-6,
    )
